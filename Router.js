...
const HomeStackScreen = () => {
    return (
        ...
        <HomeStack.Navigator initialRouteName={constants.SCREEN.HOME}
            screenOptions={{
                headerStyle: {
        ...
        >
            ...
            <HomeStack.Screen name={constants.SCREEN.HOME} component={HomeScreen} 
                options={{
                    title: 'MOVIES',
                    headerShown: false,
            }}/>
            ...
            <HomeStack.Screen name={constants.SCREEN.DETAILS} component={DetailsScreen} 
                options={ {
                    title: '',
